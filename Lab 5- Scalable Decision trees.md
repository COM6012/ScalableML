...
Last modified by Robert Loftin, 10th March 2026

## Study schedule

- [Section 1](#1-decision-trees-in-pyspark): To finish in the lab session on 11th March. **Essential**
- [Section 2](#2-ensemble-methods): To finish in the lab session on 11th March. **Essential**
- [Section 3](#3-exercises): To finish by the following Monday, 16th March. ***Exercise***
...
We use the [`withColumnRenamed`](https://spark.apache.org/docs/3.0.1/api/python/pyspark.sql.html?highlight=withcolumn#pyspark.sql.DataFrame.withColumnRenamed) method for the dataframe to rename the columns using the more familiar names for the features.
...
1. Drop lines containing `NaN`
2. Replace `NaN` with the average value from that column. For this, you can use the [Imputer](http://spark.apache.org/docs/latest/ml-features.html#imputer) transformer available in `pyspark.ml.feature`
