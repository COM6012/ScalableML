e# Lab 7: PCA for dimensionality reduction

[COM6012 Scalable Machine Learning **2026**](https://github.com/COM6012/ScalableML) by Robert Loftin

## Study schedule

- [Task 1](#1-data-types-in-rdd-based-api): To finish in the lab session on 25th March. **Essential**
- [Task 2](#2-pca): To finish in the lab session on 25th March. **Essential**
- [Task 3](#3-exercises): To finish by the following Monday 30th March. ***Exercise***
- [Task 4](#4-additional-ideas-to-explore-optional): To explore further. *Optional*

### Suggested reading

- [Extracting, transforming and selecting features](https://spark.apache.org/docs/4.1.0/ml-features.html)
- [PCA in Spark DataFrame API `pyspark.ml`](https://spark.apache.org/docs/4.1.0/ml-features.html#pca)
- [SVD in Spark RDD API `pyspark.mllib`](https://spark.apache.org/docs/4.1.0/mllib-dimensionality-reduction.html#singular-value-decomposition-svd)
- [StandardScaler in Spark](https://spark.apache.org/docs/4.1.0/ml-features.html#standardscaler) to standardise/normalise data to unit standard deviation and/or zero mean.
- [Data Types - RDD-based API](https://spark.apache.org/docs/4.1.0/mllib-data-types.html)
...
### [Labeled point](https://spark.apache.org/docs/4.1.0/mllib-data-types.html#labeled-point)
...
### [Local matrix](https://spark.apache.org/docs/4.1.0/mllib-data-types.html#local-matrix)
...
### [Distributed matrix](https://spark.apache.org/docs/4.1.0/mllib-data-types.html#distributed-matrix)
...
Check out the [API](https://spark.apache.org/docs/4.1.0/api/python/reference/api/pyspark.ml.feature.PCA.html?highlight=pyspark%20ml%20feature%20pca#pyspark.ml.feature.PCA). Check [`pyspark.ml.feature.PCAModel`](https://spark.apache.org/docs/4.1.0/api/python/reference/api/pyspark.ml.feature.PCAModel.html?highlight=pyspark%20ml%20feature%20pcamodel#pyspark.ml.feature.PCAModel) too to see what is available for the fitted model. Let us project three 5-dimensional feature vectors into 2-dimensional principal components.
...
But it is **not the same**! Why? Remeber that we need to do **centering**! We can do so use the [StandardScaler (check out the API](https://spark.apache.org/docs/4.1.0/mllib-feature-extraction.html#standardscaler)) to center the data, i.e., remove the mean.
